...
namespace PrimerProyecto.Models
{
    public class Inmueble
    {
        ...
        [StringLength(50, MinimumLength = 10, ErrorMessage = "La longitud del {0} deberia ser entre {2} y {1}."), RegularExpression("^[A-Za-z]+$", ErrorMessage = "Solo estan permitidas letras")]
